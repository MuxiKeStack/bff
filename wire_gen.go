...
func InitWebServer() *ginx.Server {
	...
	courseHandler := web.NewCourseHandler(handler, courseServiceClient, evaluationServiceClient, userServiceClient, tagServiceClient, logger, interactServiceClient)
